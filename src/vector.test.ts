...
describe('vector tests', () => {
  describe('dimension tests', () => {
    it('one dimensional vertices', () => expect(new Vector(1).dim()).toBe(1));
    it('two dimensional vertices', () => expect(new Vector(1, 1).dim()).toBe(2));
    it('three dimensional vertices', () => expect(new Vector(1, 1, 1).dim()).toBe(3));
  });

  describe('component getter tests', () => {
    it('x component', () => expect(new Vector(1, 2).x).toBe(1));
    it('y component', () => expect(new Vector(1, 2).y).toBe(2));
  });

  describe('norm tests', () => {
    it('||(0,1)|| = 1', () => expect(new Vector(0,1).norm()).toBe(1));
    it('||(1,0)|| = 1', () => expect(new Vector(1,0).norm()).toBe(1));
    it('||(0,-2)|| = 2', () => expect(new Vector(0,-2).norm()).toBe(2));
    it('||(-2,0)|| = 2', () => expect(new Vector(-2,0).norm()).toBe(2));
    it('||(3,4)|| = 5', () => expect(new Vector(3,4).norm()).toBe(5));
  });

  describe('dot product tests', () => {
    const test = (x: number[], y: number[], e: number) => expect(new Vector(...x).dot(new Vector(...y))).toEqual(e);    
  ...
  describe('substract tests', () => {
    const test = (x: number[], y: number[], e: number[]) => expect(new Vector(...x).subtract(new Vector(...y)).coordinates).toEqual(e);
    it('1 - 0 = 1', () => test([1,1], [0,0], [1,1]));
    it('0 - 1 = -1', () => test([0,0], [1,1], [-1,-1]));
    it('1 - 1 = 0', () => test([1,1], [1,1], [0,0]));
  });
  describe('add tests', () => {
    const test = (x: number[], y: number[], e: number[]) => expect(new Vector(...x).add(new Vector(...y)).coordinates).toEqual(e);
    it('1 + 0 = 1', () => test([1,1], [0,0], [1,1]));
    it('0 + 1 = 1', () => test([0,0], [1,1], [1,1]));
    it('0 + 0 = 0', () => test([0,0], [0,0], [0,0]));
  });
  describe('scale tests', () => {
    const test = (x: number[], factor: number, e: number[]) => expect(new Vector(...x).scale(factor).coordinates).toEqual(e);
  ...
  describe('rotation tests', () => {
    const test = (components: number[], angle: number, e: number[]) => {
      const actual = new Vector(...components).rotate(angle);
  ...
  describe('orthogonality checks', () => {
    const test = (u: number[], v: number[], e: boolean) => expect(new Vector(...u).isOrthogonalTo(new Vector(...v))).toEqual(e);
  ...
  describe('distance calculation', () => {
    const test = (u: number[], v: number[], e: number) => expect(new Vector(...u).distanceTo(new Vector(...v))).toEqual(e);
    it('d([0,1],[1,0])', () => test([0,1], [1,0], math.sqrt(2)));
    it('d([0,0],[1,0])', () => test([0,0], [1,0], 1));
    it('d([0,3],[4,0])', () => test([0,3], [4,0], 5));
  });
  describe('angle calculation', () => {
    const test = (u: number[], v: number[], e: number) => expect(new Vector(...u).angleWith(new Vector(...v))).toBeCloseTo(e);
  ...
  describe('projection tests', () => {
    const test = (u: number[], v: number[], e: number[]) => expect(new Vector(...u).proj(new Vector(...v)).coordinates).toEqual(e);
