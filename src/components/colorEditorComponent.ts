...
export class ColorEditorComponent extends HTMLElement {
    ...
    constructor() {
        ...
        this.tileElement = shadowRoot.querySelector('#tile');        
        this.redElement = shadowRoot.querySelector('#red');
        this.greenElement = shadowRoot.querySelector('#green');        
        this.blueElement = shadowRoot.querySelector('#blue');
        this.alphaElement = shadowRoot.querySelector('#alpha');        
