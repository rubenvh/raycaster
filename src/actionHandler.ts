...
export class ActionHandler {
    ...
    handle() {
        ...
        if (this.actions.left) this.world.camera = strafe(-0.1, this.world.camera);
        if (this.actions.right) this.world.camera = strafe(0.1, this.world.camera);
        if (this.actions.up) this.world.camera  = move(0.1, this.world.camera);
        if (this.actions.down) this.world.camera = move(-0.1, this.world.camera);
